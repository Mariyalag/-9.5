...
# if self.step > 0:
        ...
        # current = self.pointer
        # self.pointer += self.step
        # return current - решение к методу некст более подробно для моей задачи выше
...
#
# print(sys.getsizeof(ex_str) / sys.getsizeof(ex_itertator))
...
#         self.i = 0
#         # возвращаем ссыоку на себя, так как сам объект дб итератором
#         return self
#
#     def __next__(self):
